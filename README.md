...
3. Configure Secrets
Create a file named terraform.tfvars inside the 01-basic-cluster directory to set your server password securely and add this line to the file:
